...
def get_lc_id(ly0_x, ly1_x, ly2_x, ly3_x, ly4_x, ly5_x, MAX_SPAN=37):
    """takes in the data from each layer to determine the layer count that would be obtained from the data overlaying any mask; returns id and layer count for each mask"""
    lc_vec_x = []
    lc_id_vec = []
...
def process_pat(ly0_x, ly1_x, ly2_x, ly3_x, ly4_x, ly5_x, MAX_SPAN=37):
    ...
    lc_id_vec = get_lc_id(ly0_x, ly1_x, ly2_x, ly3_x, ly4_x, ly5_x, MAX_SPAN)
