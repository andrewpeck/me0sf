...
def read_ntuple_v2(file_path):
    with uproot.open(file_path + ":ME0HitAnalyzer/Events") as Events:
        ...
        events = Events.arrays(
            ...
            aliases = {
                ############# sim ##############
                'me0_sim_track_id_i': "sim_track_id",
                'me0_sim_track_type_i': "sim_track_type", 
                'me0_sim_track_charge_i': "sim_track_charge", 
                'me0_sim_track_pt_i': "sim_track_pt", 
                'me0_sim_track_phi_i': "sim_track_phi", 
                'me0_sim_track_eta_i': "sim_track_eta", 
                'me0_sim_track_energy_i': "sim_track_energy", 
                'me0_sim_track_hit_index_i': "sim_track_hit_index", 
                'me0_sim_hit_particle_i': "sim_hit_particle", 
                'me0_sim_hit_region_i': "sim_hit_region", 
                'me0_sim_hit_chamber_i': "sim_hit_chamber", 
                'me0_sim_hit_layer_i': "sim_hit_layer", 
                'me0_sim_hit_strip_i': "sim_hit_strip", 
                'me0_sim_hit_tof_i': "sim_hit_tof", 
                'me0_sim_hit_x_i': "sim_hit_x", 
                'me0_sim_hit_y_i': "sim_hit_y", 
                'me0_sim_hit_z_i': "sim_hit_z", 
                'me0_sim_hit_r_i': "sim_hit_r", 
                'me0_sim_hit_eta_i': "sim_hit_eta", 
                'me0_sim_hit_phi_i': "sim_hit_phi", 
                'me0_sim_hit_eta_partition_i': "sim_hit_ieta", 
                #'sim_hit_trackid_ime0_sim_hit_trackid", 
                'me0_sim_hit_energyLoss_i': "sim_hit_energyLoss", 
                'me0_sim_hit_pabs_i': "sim_hit_pabs", 
                'me0_sim_hit_thetaAtEntry_i': "sim_hit_thetaAtEntry", 
                'me0_sim_hit_phiAtEntry_i': "sim_hit_phiAtEntry", 
                'me0_sim_hit_processType_i': "sim_hit_processType", 
                'me0_sim_hit_digilink_i': "sim_hit_digilink", 
                ############# digi ##############
                'me0_digi_hit_region_i': "digi_hit_region", 
                'me0_digi_hit_chamber_i': "digi_hit_chamber", 
                'me0_digi_hit_layer_i': "digi_hit_layer", 
                'me0_digi_hit_bx_i': "digi_hit_bx", 
                'me0_digi_hit_strip_i': "digi_hit_strip", 
                'me0_digi_hit_eta_partition_i': "digi_hit_ieta", 
                ############# rec ##############
                'me0_rec_hit_region_i': "rec_hit_region", 
                'me0_rec_hit_chamber_i': "rec_hit_chamber", 
                'me0_rec_hit_layer_i': "rec_hit_layer", 
                'me0_rec_hit_strip_i': "rec_hit_strip", 
                'me0_rec_hit_tof_i': "rec_hit_tof", 
                'me0_rec_hit_bx_i': "rec_hit_bx", 
                'me0_rec_hit_cluster_size_i': "rec_hit_cluster_size", 
                'me0_rec_hit_x_i': "rec_hit_x", 
                'me0_rec_hit_y_i': "rec_hit_y", 
                'me0_rec_hit_z_i': "rec_hit_z", 
                'me0_rec_hit_r_i': "rec_hit_r", 
                'me0_rec_hit_eta_i': "rec_hit_eta", 
                'me0_rec_hit_phi_i': "rec_hit_phi", 
                'me0_rec_hit_eta_partition_i': "rec_hit_ieta", 
                ############# seg ##############
                'me0_seg_region_i': "seg_region", 
                'me0_seg_chamber_i': "seg_chamber", 
                'me0_seg_nRecHits_i': "seg_nRecHits", 
                'me0_seg_deltaPhi_i': "seg_deltaPhi", 
                'me0_seg_chi2_i': "seg_chi2", 
                'me0_seg_ndof_i': "seg_ndof", 
                'me0_seg_bunchX_i': "seg_bunchX", 
                'me0_seg_origin_x_i': "seg_origin_x", 
                'me0_seg_origin_y_i': "seg_origin_y", 
                'me0_seg_origin_z_i': "seg_origin_z", 
                'me0_seg_origin_r_i': "seg_origin_r", 
                'me0_seg_origin_eta_i': "seg_origin_eta", 
                'me0_seg_origin_phi_i': "seg_origin_phi", 
                'me0_seg_dir_theta_i': "seg_dir_theta", 
                'me0_seg_dir_phi_i': "seg_dir_phi", 
                'me0_seg_param_dxdz_i': "seg_param_dxdz", 
                'me0_seg_param_dydz_i': "seg_param_dydz", 
