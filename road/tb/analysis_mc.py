...
def analysis(root_dat, hits, bx, bx_list, cross_part, verbose, pu, num_or):
    ...
    num_bkg_seg_per_chamber_per_event_bending1.SetStats(False)
    num_bkg_seg_per_chamber_per_event_bending1.SetTitle("")
    num_bkg_seg_per_chamber_per_event_bending1.SetXTitle("Bending Angle (sbits/layer)")
    num_bkg_seg_per_chamber_per_event_bending1.SetYTitle("Nr. of Fakes per Chamber per BX")
    ...
    num_bkg_seg_per_chamber_per_event_bending_stack.Draw("same")
    ROOT.gPad.Update()
    ...
    num_signal_seg_per_chamber_per_event_bending1.SetStats(False)
    num_signal_seg_per_chamber_per_event_bending1.SetTitle("")
    num_signal_seg_per_chamber_per_event_bending1.SetXTitle("Bending Angle (sbits/layer)")
    num_signal_seg_per_chamber_per_event_bending1.SetYTitle("Nr. of Signal Segments per Chamber per BX")
    ...
    num_signal_seg_per_chamber_per_event_bending_stack.Draw("same")
    ROOT.gPad.Update()
