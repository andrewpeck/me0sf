...
def analysis(root_dat, hits, bx, bx_list, cross_part, verbose, pu, num_or):
    ...
    num_bkg_seg_per_chamber_per_event_bending_eta1 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_bending_eta1", "num_bkg_seg_per_chamber_per_event_bending_eta1",80,-4,4)
    num_bkg_seg_per_chamber_per_event_bending_eta2 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_bending_eta2", "num_bkg_seg_per_chamber_per_event_bending_eta2",80,-4,4)
    num_bkg_seg_per_chamber_per_event_bending_eta3 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_bending_eta3", "num_bkg_seg_per_chamber_per_event_bending_eta3",80,-4,4)
    num_bkg_seg_per_chamber_per_event_bending_eta4 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_bending_eta4", "num_bkg_seg_per_chamber_per_event_bending_eta4",80,-4,4)
    num_bkg_seg_per_chamber_per_event_bending_eta5 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_bending_eta5", "num_bkg_seg_per_chamber_per_event_bending_eta5",80,-4,4)
    num_bkg_seg_per_chamber_per_event_bending_eta6 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_bending_eta6", "num_bkg_seg_per_chamber_per_event_bending_eta6",80,-4,4)
    num_bkg_seg_per_chamber_per_event_bending_eta7 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_bending_eta7", "num_bkg_seg_per_chamber_per_event_bending_eta7",80,-4,4)
    num_bkg_seg_per_chamber_per_event_bending_eta8 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_bending_eta8", "num_bkg_seg_per_chamber_per_event_bending_eta8",80,-4,4)
    num_bkg_seg_per_chamber_per_event_nlayers = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers", "num_bkg_seg_per_chamber_per_event_nlayers",6,0.5,6.5)
    num_bkg_seg_per_chamber_per_event_nlayers1 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers1", "num_bkg_seg_per_chamber_per_event_nlayers1",6,0.5,6.5) 
    num_bkg_seg_per_chamber_per_event_nlayers2 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers2", "num_bkg_seg_per_chamber_per_event_nlayers2",6,0.5,6.5) 
    num_bkg_seg_per_chamber_per_event_nlayers3 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers3", "num_bkg_seg_per_chamber_per_event_nlayers3",6,0.5,6.5) 
    num_bkg_seg_per_chamber_per_event_nlayers4 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers4", "num_bkg_seg_per_chamber_per_event_nlayers4",6,0.5,6.5) 
    num_bkg_seg_per_chamber_per_event_nlayers5 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers5", "num_bkg_seg_per_chamber_per_event_nlayers5",6,0.5,6.5) 
    num_bkg_seg_per_chamber_per_event_nlayers6 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers6", "num_bkg_seg_per_chamber_per_event_nlayers6",6,0.5,6.5) 
    num_bkg_seg_per_chamber_per_event_nlayers7 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers7", "num_bkg_seg_per_chamber_per_event_nlayers7",6,0.5,6.5) 
    num_bkg_seg_per_chamber_per_event_nlayers8 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers8", "num_bkg_seg_per_chamber_per_event_nlayers8",6,0.5,6.5) 
    num_bkg_seg_per_chamber_per_event_nlayers9 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers9", "num_bkg_seg_per_chamber_per_event_nlayers9",6,0.5,6.5) 
    num_bkg_seg_per_chamber_per_event_nlayers10 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers10", "num_bkg_seg_per_chamber_per_event_nlayers10",6,0.5,6.5) 
    num_bkg_seg_per_chamber_per_event_nlayers11 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers11", "num_bkg_seg_per_chamber_per_event_nlayers11",6,0.5,6.5) 
    num_bkg_seg_per_chamber_per_event_nlayers12 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers12", "num_bkg_seg_per_chamber_per_event_nlayers12",6,0.5,6.5) 
    num_bkg_seg_per_chamber_per_event_nlayers13 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers13", "num_bkg_seg_per_chamber_per_event_nlayers13",6,0.5,6.5) 
    num_bkg_seg_per_chamber_per_event_nlayers14 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers14", "num_bkg_seg_per_chamber_per_event_nlayers14",6,0.5,6.5) 
    num_bkg_seg_per_chamber_per_event_nlayers15 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers15", "num_bkg_seg_per_chamber_per_event_nlayers15",6,0.5,6.5) 
    num_bkg_seg_per_chamber_per_event_nlayers16 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers16", "num_bkg_seg_per_chamber_per_event_nlayers16",6,0.5,6.5) 
    num_bkg_seg_per_chamber_per_event_nlayers17 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers17", "num_bkg_seg_per_chamber_per_event_nlayers17",6,0.5,6.5) 
    num_bkg_seg_per_chamber_per_event_nlayers_eta1 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers_eta1", "num_bkg_seg_per_chamber_per_event_nlayers_eta1",6,0.5,6.5)
    num_bkg_seg_per_chamber_per_event_nlayers_eta2 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers_eta2", "num_bkg_seg_per_chamber_per_event_nlayers_eta2",6,0.5,6.5)
    num_bkg_seg_per_chamber_per_event_nlayers_eta3 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers_eta3", "num_bkg_seg_per_chamber_per_event_nlayers_eta3",6,0.5,6.5)
    num_bkg_seg_per_chamber_per_event_nlayers_eta4 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers_eta4", "num_bkg_seg_per_chamber_per_event_nlayers_eta4",6,0.5,6.5)
    num_bkg_seg_per_chamber_per_event_nlayers_eta5 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers_eta5", "num_bkg_seg_per_chamber_per_event_nlayers_eta5",6,0.5,6.5)
    num_bkg_seg_per_chamber_per_event_nlayers_eta6 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers_eta6", "num_bkg_seg_per_chamber_per_event_nlayers_eta6",6,0.5,6.5)
    num_bkg_seg_per_chamber_per_event_nlayers_eta7 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers_eta7", "num_bkg_seg_per_chamber_per_event_nlayers_eta7",6,0.5,6.5)
    num_bkg_seg_per_chamber_per_event_nlayers_eta8 = ROOT.TH1F("num_bkg_seg_per_chamber_per_event_nlayers_eta8", "num_bkg_seg_per_chamber_per_event_nlayers_eta8",6,0.5,6.5)
    ...
    num_signal_seg_per_chamber_per_event_nlayers = ROOT.TH1F("num_signal_seg_per_chamber_per_event_nlayers", "num_signal_seg_per_chamber_per_event_nlayers",6,0.5,6.5)
    num_signal_seg_per_chamber_per_event_bending_eta1 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_bending_eta1", "num_signal_seg_per_chamber_per_event_bending_eta1",40,-2,2)
    num_signal_seg_per_chamber_per_event_bending_eta2 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_bending_eta2", "num_signal_seg_per_chamber_per_event_bending_eta2",40,-2,2)
    num_signal_seg_per_chamber_per_event_bending_eta3 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_bending_eta3", "num_signal_seg_per_chamber_per_event_bending_eta3",40,-2,2)
    num_signal_seg_per_chamber_per_event_bending_eta4 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_bending_eta4", "num_signal_seg_per_chamber_per_event_bending_eta4",40,-2,2)
    num_signal_seg_per_chamber_per_event_bending_eta5 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_bending_eta5", "num_signal_seg_per_chamber_per_event_bending_eta5",40,-2,2)
    num_signal_seg_per_chamber_per_event_bending_eta6 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_bending_eta6", "num_signal_seg_per_chamber_per_event_bending_eta6",40,-2,2)
    num_signal_seg_per_chamber_per_event_bending_eta7 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_bending_eta7", "num_signal_seg_per_chamber_per_event_bending_eta7",40,-2,2)
    num_signal_seg_per_chamber_per_event_bending_eta8 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_bending_eta8", "num_signal_seg_per_chamber_per_event_bending_eta8",40,-2,2)
    num_signal_seg_per_chamber_per_event_nlayers1 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_nlayers1", "num_signal_seg_per_chamber_per_event_nlayers1",6,0.5,6.5) 
    num_signal_seg_per_chamber_per_event_nlayers2 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_nlayers2", "num_signal_seg_per_chamber_per_event_nlayers2",6,0.5,6.5) 
    num_signal_seg_per_chamber_per_event_nlayers3 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_nlayers3", "num_signal_seg_per_chamber_per_event_nlayers3",6,0.5,6.5) 
    num_signal_seg_per_chamber_per_event_nlayers4 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_nlayers4", "num_signal_seg_per_chamber_per_event_nlayers4",6,0.5,6.5) 
    num_signal_seg_per_chamber_per_event_nlayers5 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_nlayers5", "num_signal_seg_per_chamber_per_event_nlayers5",6,0.5,6.5) 
    num_signal_seg_per_chamber_per_event_nlayers6 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_nlayers6", "num_signal_seg_per_chamber_per_event_nlayers6",6,0.5,6.5) 
    num_signal_seg_per_chamber_per_event_nlayers7 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_nlayers7", "num_signal_seg_per_chamber_per_event_nlayers7",6,0.5,6.5) 
    num_signal_seg_per_chamber_per_event_nlayers8 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_nlayers8", "num_signal_seg_per_chamber_per_event_nlayers8",6,0.5,6.5) 
    num_signal_seg_per_chamber_per_event_nlayers9 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_nlayers9", "num_signal_seg_per_chamber_per_event_nlayers9",6,0.5,6.5) 
    num_signal_seg_per_chamber_per_event_nlayers10 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_nlayers10", "num_signal_seg_per_chamber_per_event_nlayers10",6,0.5,6.5) 
    num_signal_seg_per_chamber_per_event_nlayers11 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_nlayers11", "num_signal_seg_per_chamber_per_event_nlayers11",6,0.5,6.5) 
    num_signal_seg_per_chamber_per_event_nlayers12 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_nlayers12", "num_signal_seg_per_chamber_per_event_nlayers12",6,0.5,6.5) 
    num_signal_seg_per_chamber_per_event_nlayers13 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_nlayers13", "num_signal_seg_per_chamber_per_event_nlayers13",6,0.5,6.5) 
    num_signal_seg_per_chamber_per_event_nlayers14 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_nlayers14", "num_signal_seg_per_chamber_per_event_nlayers14",6,0.5,6.5) 
    num_signal_seg_per_chamber_per_event_nlayers15 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_nlayers15", "num_signal_seg_per_chamber_per_event_nlayers15",6,0.5,6.5) 
    num_signal_seg_per_chamber_per_event_nlayers16 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_nlayers16", "num_signal_seg_per_chamber_per_event_nlayers16",6,0.5,6.5) 
    num_signal_seg_per_chamber_per_event_nlayers17 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_nlayers17", "num_signal_seg_per_chamber_per_event_nlayers17",6,0.5,6.5) 
    num_signal_seg_per_chamber_per_event_nlayers_eta1 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_nlayers_eta1", "num_signal_seg_per_chamber_per_event_nlayers_eta1",6,0.5,6.5)
    num_signal_seg_per_chamber_per_event_nlayers_eta2 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_nlayers_eta2", "num_signal_seg_per_chamber_per_event_nlayers_eta2",6,0.5,6.5)
    num_signal_seg_per_chamber_per_event_nlayers_eta3 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_nlayers_eta3", "num_signal_seg_per_chamber_per_event_nlayers_eta3",6,0.5,6.5)
    num_signal_seg_per_chamber_per_event_nlayers_eta4 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_nlayers_eta4", "num_signal_seg_per_chamber_per_event_nlayers_eta4",6,0.5,6.5)
    num_signal_seg_per_chamber_per_event_nlayers_eta5 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_nlayers_eta5", "num_signal_seg_per_chamber_per_event_nlayers_eta5",6,0.5,6.5)
    ...
    # bx_offset_0_index = bx_offset_windows.index(0)
            ...
            for seg in seglist_final[chamber][bx_offset_0_index]:
                ...
                if match_found == 0:
                    ...
                    if (online_eta_partition+1) == 1:
                        num_bkg_seg_per_chamber_per_event_bending_eta1.Fill(online_bending_angle)
                    elif (online_eta_partition+1) == 2:
                        num_bkg_seg_per_chamber_per_event_bending_eta2.Fill(online_bending_angle)
                    elif (online_eta_partition+1) == 3:
                        num_bkg_seg_per_chamber_per_event_bending_eta3.Fill(online_bending_angle)
                    elif (online_eta_partition+1) == 4:
                        num_bkg_seg_per_chamber_per_event_bending_eta4.Fill(online_bending_angle)
                    elif (online_eta_partition+1) == 5:
                        num_bkg_seg_per_chamber_per_event_bending_eta5.Fill(online_bending_angle)
                    elif (online_eta_partition+1) == 6:
                        num_bkg_seg_per_chamber_per_event_bending_eta6.Fill(online_bending_angle)
                    elif (online_eta_partition+1) == 7:
                        num_bkg_seg_per_chamber_per_event_bending_eta7.Fill(online_bending_angle)
                    elif (online_eta_partition+1) == 8:
                        num_bkg_seg_per_chamber_per_event_bending_eta8.Fill(online_bending_angle)
                    
                    num_bkg_seg_per_chamber_per_event_nlayers.Fill(online_lc)
                    if online_id == 1:
                        num_bkg_seg_per_chamber_per_event_nlayers1.Fill(online_lc)
                    elif online_id == 2:
                        num_bkg_seg_per_chamber_per_event_nlayers2.Fill(online_lc)
                    elif online_id == 3:
                        num_bkg_seg_per_chamber_per_event_nlayers3.Fill(online_lc)
                    elif online_id == 4:
                        num_bkg_seg_per_chamber_per_event_nlayers4.Fill(online_lc)
                    elif online_id == 5:
                        num_bkg_seg_per_chamber_per_event_nlayers5.Fill(online_lc)
                    elif online_id == 6:
                        num_bkg_seg_per_chamber_per_event_nlayers6.Fill(online_lc)
                    elif online_id == 7:
                        num_bkg_seg_per_chamber_per_event_nlayers7.Fill(online_lc)
                    elif online_id == 8:
                        num_bkg_seg_per_chamber_per_event_nlayers8.Fill(online_lc)
                    elif online_id == 9:
                        num_bkg_seg_per_chamber_per_event_nlayers9.Fill(online_lc)
                    elif online_id == 10:
                        num_bkg_seg_per_chamber_per_event_nlayers10.Fill(online_lc)
                    elif online_id == 11:
                        num_bkg_seg_per_chamber_per_event_nlayers11.Fill(online_lc)
                    elif online_id == 12:
                        num_bkg_seg_per_chamber_per_event_nlayers12.Fill(online_lc)
                    elif online_id == 13:
                        num_bkg_seg_per_chamber_per_event_nlayers13.Fill(online_lc)
                    elif online_id == 14:
                        num_bkg_seg_per_chamber_per_event_nlayers14.Fill(online_lc)
                    elif online_id == 15:
                        num_bkg_seg_per_chamber_per_event_nlayers15.Fill(online_lc)
                    elif online_id == 16:
                        num_bkg_seg_per_chamber_per_event_nlayers16.Fill(online_lc)
                    elif online_id == 17:
    ...
    print ("Number of background segments per chamber per event = %.4f\n"%n_bkg_seg_per_chamber_per_event)
    file_out.write("Number of background segments per chamber per event = %.4f\n\n"%n_bkg_seg_per_chamber_per_event)
    rate_bkg_seg_per_chamber_per_event = (n_bkg_seg_per_chamber_per_event*1000) / (25.0)
    print ("Rate of background segments per chamber per event = %.4f MHz\n"%rate_bkg_seg_per_chamber_per_event)
    file_out.write("Rate of background segments per chamber per event = %.4f MHz\n\n"%rate_bkg_seg_per_chamber_per_event)
    rate_with_ff_bkg_seg_per_chamber_per_event = (n_bkg_seg_per_chamber_per_event*1000*0.7710) / (25.0)
    print ("Rate of background segments per chamber per event (with fill factor of 0.7710) = %.4f MHz\n"%rate_with_ff_bkg_seg_per_chamber_per_event)
    file_out.write("Rate of background segments per chamber per event (with fill factor of 0.7710) = %.4f MHz\n\n"%rate_with_ff_bkg_seg_per_chamber_per_event)

    n_signal_seg_per_chamber_per_event /= (36.0*n_total_events)
    print ("Number of signal segments per chamber per event = %.4f\n"%n_signal_seg_per_chamber_per_event)
    file_out.write("Number of signal segments per chamber per event = %.4f\n\n"%n_signal_seg_per_chamber_per_event)
    rate_signal_seg_per_chamber_per_event = (n_signal_seg_per_chamber_per_event*1000) / (25.0)
    print ("Rate of signal segments per chamber per event = %.4f MHz\n"%rate_signal_seg_per_chamber_per_event)
    file_out.write("Rate of signal segments per chamber per event = %.4f MHz\n\n"%rate_signal_seg_per_chamber_per_event)
    ...
    if n_st_effi_total != 0:
        ...
        c_pt_eta_low.SetLeftMargin(0.12)
        ...
        c_pt_eta_high.SetLeftMargin(0.12)
        ...
        c_pt_stacked.SetLeftMargin(0.12)
    ...
    c11.SetGrid()
    c11.DrawFrame(-0.5, -0.05, 16.5, 1.05, ";Number of Segments per Stack/Event;Fraction of Events")
    ...
    c11a.SetLeftMargin(0.12)
    c11a.SetLogy()
    c11a.SetGrid()
    c11a.DrawFrame(-0.5, 0.000001, 16.5, 1.5, ";Number of Segments per Stack/Event;Fraction of Events")
    num_seg_per_chamber.Scale(1.0/num_seg_per_chamber.Integral())
    num_seg_per_chamber.Draw("same HE")
    num_seg_per_chamber.SetMarkerStyle(8)
    num_seg_per_chamber.SetMarkerSize(1)
    ...
    c11b.SetLeftMargin(0.12)
    c11b.SetGrid()
    c11b.DrawFrame(-0.5, -0.05, 16.5, 1.05, ";Number of Segments per Stack/Event;Fraction of Events")
    ...
    c11c.SetLeftMargin(0.12)
    c11c.SetLogy()
    c11c.SetGrid()
    c11c.DrawFrame(-0.5, 0.000001, 16.5, 1.5, ";Number of Segments per Stack/Event;Fraction of Events")
    num_bkg_seg_per_chamber.Scale(1.0/num_bkg_seg_per_chamber.Integral())
    num_bkg_seg_per_chamber.Draw("same HE")
    num_bkg_seg_per_chamber.SetMarkerStyle(8)
    num_bkg_seg_per_chamber.SetMarkerSize(1)
    ...
    c11d = ROOT.TCanvas('', '', 800, 650)
    c11d.SetLeftMargin(0.12)
    c11d.SetGrid()
    c11d.DrawFrame(-0.5, -0.05, 16.5, 1.05, ";Number of Segments per Stack/Event;Fraction of Events")
    num_signal_seg_per_chamber.Scale(1.0/num_signal_seg_per_chamber.Integral())
    num_signal_seg_per_chamber.Draw("same HE")
    num_signal_seg_per_chamber.SetMarkerStyle(8)
    num_signal_seg_per_chamber.SetMarkerSize(1)
    num_signal_seg_per_chamber.SetMarkerColor(1)
    num_signal_seg_per_chamber.SetLineWidth(1)
    num_signal_seg_per_chamber.SetLineColor(1)
    latex.DrawLatex(0.9, 0.91,plot_text1)
    latex.DrawLatex(0.46, 0.91,plot_text2)
    c11d.Print("num_signal_seg_per_chamber_%s_bx%s_crosspart_%s_or%d.pdf"%(hits, bx, cross_part, num_or))
    num_signal_seg_per_chamber.Write()

    c11e = ROOT.TCanvas('', '', 800, 650)
    c11e.SetLeftMargin(0.12)
    c11e.SetLogy()
    c11e.SetGrid()
    c11e.DrawFrame(-0.5, 0.000001, 16.5, 1.5, ";Number of Segments per Stack/Event;Fraction of Events")
    num_signal_seg_per_chamber.Scale(1.0/num_signal_seg_per_chamber.Integral())
    num_signal_seg_per_chamber.Draw("same HE")
    num_signal_seg_per_chamber.SetMarkerStyle(8)
    num_signal_seg_per_chamber.SetMarkerSize(1)
    ...
    latex.DrawLatex(0.9, 0.91,plot_text1)
    latex.DrawLatex(0.46, 0.91,plot_text2)
    c11e.Print("num_signal_seg_per_chamber_%s_bx%s_crosspart_%s_or%d_log.pdf"%(hits, bx, cross_part, num_or))

    c12 = ROOT.TCanvas('', '', 800, 650)
    c12.SetLeftMargin(0.12)
    c12.SetGrid()
    c12.DrawFrame(-0.5, -0.05, 16.5, 1.05, ";Number of Offline Segments per Stack/Event;Fraction of Events")
    ...
    c12a.SetLeftMargin(0.12)
    c12a.SetLogy()
    c12a.SetGrid()
    c12a.DrawFrame(-0.5, 0.000001, 16.5, 1.5, ";Number of Offline Segments per Stack/Event;Fraction of Events")
    num_seg_per_chamber_offline.Scale(1.0/num_seg_per_chamber_offline.Integral())
    num_seg_per_chamber_offline.Draw("same HE")
    num_seg_per_chamber_offline.SetMarkerStyle(8)
    num_seg_per_chamber_offline.SetMarkerSize(1)
    ...
    num_bkg_seg_per_chamber_per_event_bending.SetYTitle("Nr. of Segments per Stack per BX")
    ...
    c13b_eta1.SetLeftMargin(0.12)
    c13b_eta1.SetGrid()
    num_bkg_seg_per_chamber_per_event_bending_eta1.SetStats(False)
    num_bkg_seg_per_chamber_per_event_bending_eta1.SetTitle("")
    num_bkg_seg_per_chamber_per_event_bending_eta1.SetXTitle("Bending Angle (sbits/layer)")
    num_bkg_seg_per_chamber_per_event_bending_eta1.SetYTitle("Nr. of Segments per Stack per BX")
    num_bkg_seg_per_chamber_per_event_bending_eta1.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_bending_eta1.Draw("same HE")
    num_bkg_seg_per_chamber_per_event_bending_eta1.SetMarkerStyle(8)
    num_bkg_seg_per_chamber_per_event_bending_eta1.SetMarkerSize(1)
    num_bkg_seg_per_chamber_per_event_bending_eta1.SetMarkerColor(1)
    num_bkg_seg_per_chamber_per_event_bending_eta1.SetLineWidth(1)
    ...
    c13b_eta2.SetLeftMargin(0.12)
    c13b_eta2.SetGrid()
    num_bkg_seg_per_chamber_per_event_bending_eta2.SetStats(False)
    num_bkg_seg_per_chamber_per_event_bending_eta2.SetTitle("")
    num_bkg_seg_per_chamber_per_event_bending_eta2.SetXTitle("Bending Angle (sbits/layer)")
    num_bkg_seg_per_chamber_per_event_bending_eta2.SetYTitle("Nr. of Segments per Stack per BX")
    num_bkg_seg_per_chamber_per_event_bending_eta2.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_bending_eta2.Draw("same HE")
    num_bkg_seg_per_chamber_per_event_bending_eta2.SetMarkerStyle(8)
    num_bkg_seg_per_chamber_per_event_bending_eta2.SetMarkerSize(1)
    num_bkg_seg_per_chamber_per_event_bending_eta2.SetMarkerColor(1)
    num_bkg_seg_per_chamber_per_event_bending_eta2.SetLineWidth(1)
    ...
    c13b_eta3.SetLeftMargin(0.12)
    c13b_eta3.SetGrid()
    num_bkg_seg_per_chamber_per_event_bending_eta3.SetStats(False)
    num_bkg_seg_per_chamber_per_event_bending_eta3.SetTitle("")
    num_bkg_seg_per_chamber_per_event_bending_eta3.SetXTitle("Bending Angle (sbits/layer)")
    num_bkg_seg_per_chamber_per_event_bending_eta3.SetYTitle("Nr. of Segments per Stack per BX")
    num_bkg_seg_per_chamber_per_event_bending_eta3.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_bending_eta3.Draw("same HE")
    num_bkg_seg_per_chamber_per_event_bending_eta3.SetMarkerStyle(8)
    num_bkg_seg_per_chamber_per_event_bending_eta3.SetMarkerSize(1)
    num_bkg_seg_per_chamber_per_event_bending_eta3.SetMarkerColor(1)
    num_bkg_seg_per_chamber_per_event_bending_eta3.SetLineWidth(1)
    ...
    c13b_eta4.SetLeftMargin(0.12)
    c13b_eta4.SetGrid()
    num_bkg_seg_per_chamber_per_event_bending_eta4.SetStats(False)
    num_bkg_seg_per_chamber_per_event_bending_eta4.SetTitle("")
    num_bkg_seg_per_chamber_per_event_bending_eta4.SetXTitle("Bending Angle (sbits/layer)")
    num_bkg_seg_per_chamber_per_event_bending_eta4.SetYTitle("Nr. of Segments per Stack per BX")
    num_bkg_seg_per_chamber_per_event_bending_eta4.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_bending_eta4.Draw("same HE")
    num_bkg_seg_per_chamber_per_event_bending_eta4.SetMarkerStyle(8)
    num_bkg_seg_per_chamber_per_event_bending_eta4.SetMarkerSize(1)
    num_bkg_seg_per_chamber_per_event_bending_eta4.SetMarkerColor(1)
    num_bkg_seg_per_chamber_per_event_bending_eta4.SetLineWidth(1)
    ...
    c13b_eta5.SetLeftMargin(0.12)
    c13b_eta5.SetGrid()
    num_bkg_seg_per_chamber_per_event_bending_eta5.SetStats(False)
    num_bkg_seg_per_chamber_per_event_bending_eta5.SetTitle("")
    num_bkg_seg_per_chamber_per_event_bending_eta5.SetXTitle("Bending Angle (sbits/layer)")
    num_bkg_seg_per_chamber_per_event_bending_eta5.SetYTitle("Nr. of Segments per Stack per BX")
    num_bkg_seg_per_chamber_per_event_bending_eta5.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_bending_eta5.Draw("same HE")
    num_bkg_seg_per_chamber_per_event_bending_eta5.SetMarkerStyle(8)
    num_bkg_seg_per_chamber_per_event_bending_eta5.SetMarkerSize(1)
    num_bkg_seg_per_chamber_per_event_bending_eta5.SetMarkerColor(1)
    num_bkg_seg_per_chamber_per_event_bending_eta5.SetLineWidth(1)
    ...
    c13b_eta6.SetLeftMargin(0.12)
    c13b_eta6.SetGrid()
    num_bkg_seg_per_chamber_per_event_bending_eta6.SetStats(False)
    num_bkg_seg_per_chamber_per_event_bending_eta6.SetTitle("")
    num_bkg_seg_per_chamber_per_event_bending_eta6.SetXTitle("Bending Angle (sbits/layer)")
    num_bkg_seg_per_chamber_per_event_bending_eta6.SetYTitle("Nr. of Segments per Stack per BX")
    num_bkg_seg_per_chamber_per_event_bending_eta6.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_bending_eta6.Draw("same HE")
    num_bkg_seg_per_chamber_per_event_bending_eta6.SetMarkerStyle(8)
    num_bkg_seg_per_chamber_per_event_bending_eta6.SetMarkerSize(1)
    num_bkg_seg_per_chamber_per_event_bending_eta6.SetMarkerColor(1)
    num_bkg_seg_per_chamber_per_event_bending_eta6.SetLineWidth(1)
    ...
    c13b_eta7.SetLeftMargin(0.12)
    c13b_eta7.SetGrid()
    num_bkg_seg_per_chamber_per_event_bending_eta7.SetStats(False)
    num_bkg_seg_per_chamber_per_event_bending_eta7.SetTitle("")
    num_bkg_seg_per_chamber_per_event_bending_eta7.SetXTitle("Bending Angle (sbits/layer)")
    num_bkg_seg_per_chamber_per_event_bending_eta7.SetYTitle("Nr. of Segments per Stack per BX")
    num_bkg_seg_per_chamber_per_event_bending_eta7.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_bending_eta7.Draw("same HE")
    num_bkg_seg_per_chamber_per_event_bending_eta7.SetMarkerStyle(8)
    num_bkg_seg_per_chamber_per_event_bending_eta7.SetMarkerSize(1)
    num_bkg_seg_per_chamber_per_event_bending_eta7.SetMarkerColor(1)
    num_bkg_seg_per_chamber_per_event_bending_eta7.SetLineWidth(1)
    ...
    c13b_eta8.SetLeftMargin(0.12)
    c13b_eta8.SetGrid()
    num_bkg_seg_per_chamber_per_event_bending_eta8.SetStats(False)
    num_bkg_seg_per_chamber_per_event_bending_eta8.SetTitle("")
    num_bkg_seg_per_chamber_per_event_bending_eta8.SetXTitle("Bending Angle (sbits/layer)")
    num_bkg_seg_per_chamber_per_event_bending_eta8.SetYTitle("Nr. of Segments per Stack per BX")
    num_bkg_seg_per_chamber_per_event_bending_eta8.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_bending_eta8.Draw("same HE")
    num_bkg_seg_per_chamber_per_event_bending_eta8.SetMarkerStyle(8)
    num_bkg_seg_per_chamber_per_event_bending_eta8.SetMarkerSize(1)
    num_bkg_seg_per_chamber_per_event_bending_eta8.SetMarkerColor(1)
    num_bkg_seg_per_chamber_per_event_bending_eta8.SetLineWidth(1)
    ...
    c13c.SetLeftMargin(0.12)
    c13c.SetGrid()
    c13c.DrawFrame(-4, 0, 4, 1.1*num_bkg_seg_per_chamber_per_event_bending.GetMaximum(), ";Bending Angle (sbits/layer);Nr. of Segments per Stack per BX")
    ...
    num_signal_seg_per_chamber_per_event_eta.SetMarkerStyle(8)
    num_signal_seg_per_chamber_per_event_eta.SetMarkerSize(1)
    num_signal_seg_per_chamber_per_event_eta.SetMarkerColor(1)
    num_signal_seg_per_chamber_per_event_eta.SetLineWidth(1)
    num_signal_seg_per_chamber_per_event_eta.SetLineColor(1)
    ROOT.gPad.Update()
    latex.DrawLatex(0.9, 0.91,plot_text1)
    latex.DrawLatex(0.46, 0.91,plot_text2)
    c13dd.Print("num_signal_seg_per_chamber_per_event_eta_%s_bx%s_crosspart_%s_or%d.pdf"%(hits, bx, cross_part, num_or))
    num_signal_seg_per_chamber_per_event_eta.Write()

    c13d = ROOT.TCanvas('', '', 800, 650)
    c13d.SetLeftMargin(0.12)
    c13d.SetGrid()
    ...
    num_signal_seg_per_chamber_per_event_bending.SetYTitle("Nr. of Signal Segments per Stack per BX")
    ...
    num_signal_seg_per_chamber_per_event_bending_eta1.SetXTitle("Bending Angle (sbits/layer)")
    num_signal_seg_per_chamber_per_event_bending_eta1.SetYTitle("Nr. of Segments per Stack per BX")
    num_signal_seg_per_chamber_per_event_bending_eta1.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_bending_eta1.Draw("same HE")
    num_signal_seg_per_chamber_per_event_bending_eta1.SetMarkerStyle(8)
    num_signal_seg_per_chamber_per_event_bending_eta1.SetMarkerSize(1)
    num_signal_seg_per_chamber_per_event_bending_eta1.SetMarkerColor(1)
    num_signal_seg_per_chamber_per_event_bending_eta1.SetLineWidth(1)
    ...
    num_signal_seg_per_chamber_per_event_bending_eta2.SetXTitle("Bending Angle (sbits/layer)")
    num_signal_seg_per_chamber_per_event_bending_eta2.SetYTitle("Nr. of Segments per Stack per BX")
    num_signal_seg_per_chamber_per_event_bending_eta2.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_bending_eta2.Draw("same HE")
    num_signal_seg_per_chamber_per_event_bending_eta2.SetMarkerStyle(8)
    num_signal_seg_per_chamber_per_event_bending_eta2.SetMarkerSize(1)
    num_signal_seg_per_chamber_per_event_bending_eta2.SetMarkerColor(1)
    num_signal_seg_per_chamber_per_event_bending_eta2.SetLineWidth(1)
    ...
    num_signal_seg_per_chamber_per_event_bending_eta3.SetXTitle("Bending Angle (sbits/layer)")
    num_signal_seg_per_chamber_per_event_bending_eta3.SetYTitle("Nr. of Segments per Stack per BX")
    num_signal_seg_per_chamber_per_event_bending_eta3.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_bending_eta3.Draw("same HE")
    num_signal_seg_per_chamber_per_event_bending_eta3.SetMarkerStyle(8)
    num_signal_seg_per_chamber_per_event_bending_eta3.SetMarkerSize(1)
    num_signal_seg_per_chamber_per_event_bending_eta3.SetMarkerColor(1)
    num_signal_seg_per_chamber_per_event_bending_eta3.SetLineWidth(1)
    ...
    num_signal_seg_per_chamber_per_event_bending_eta4.SetXTitle("Bending Angle (sbits/layer)")
    num_signal_seg_per_chamber_per_event_bending_eta4.SetYTitle("Nr. of Segments per Stack per BX")
    num_signal_seg_per_chamber_per_event_bending_eta4.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_bending_eta4.Draw("same HE")
    num_signal_seg_per_chamber_per_event_bending_eta4.SetMarkerStyle(8)
    num_signal_seg_per_chamber_per_event_bending_eta4.SetMarkerSize(1)
    num_signal_seg_per_chamber_per_event_bending_eta4.SetMarkerColor(1)
    num_signal_seg_per_chamber_per_event_bending_eta4.SetLineWidth(1)
    ...
    num_signal_seg_per_chamber_per_event_bending_eta5.SetXTitle("Bending Angle (sbits/layer)")
    num_signal_seg_per_chamber_per_event_bending_eta5.SetYTitle("Nr. of Segments per Stack per BX")
    num_signal_seg_per_chamber_per_event_bending_eta5.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_bending_eta5.Draw("same HE")
    num_signal_seg_per_chamber_per_event_bending_eta5.SetMarkerStyle(8)
    num_signal_seg_per_chamber_per_event_bending_eta5.SetMarkerSize(1)
    num_signal_seg_per_chamber_per_event_bending_eta5.SetMarkerColor(1)
    num_signal_seg_per_chamber_per_event_bending_eta5.SetLineWidth(1)
    ...
    num_signal_seg_per_chamber_per_event_bending_eta6.SetXTitle("Bending Angle (sbits/layer)")
    num_signal_seg_per_chamber_per_event_bending_eta6.SetYTitle("Nr. of Segments per Stack per BX")
    num_signal_seg_per_chamber_per_event_bending_eta6.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_bending_eta6.Draw("same HE")
    num_signal_seg_per_chamber_per_event_bending_eta6.SetMarkerStyle(8)
    num_signal_seg_per_chamber_per_event_bending_eta6.SetMarkerSize(1)
    num_signal_seg_per_chamber_per_event_bending_eta6.SetMarkerColor(1)
    num_signal_seg_per_chamber_per_event_bending_eta6.SetLineWidth(1)
    ...
    num_signal_seg_per_chamber_per_event_bending_eta7.SetXTitle("Bending Angle (sbits/layer)")
    num_signal_seg_per_chamber_per_event_bending_eta7.SetYTitle("Nr. of Segments per Stack per BX")
    num_signal_seg_per_chamber_per_event_bending_eta7.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_bending_eta7.Draw("same HE")
    num_signal_seg_per_chamber_per_event_bending_eta7.SetMarkerStyle(8)
    num_signal_seg_per_chamber_per_event_bending_eta7.SetMarkerSize(1)
    num_signal_seg_per_chamber_per_event_bending_eta7.SetMarkerColor(1)
    num_signal_seg_per_chamber_per_event_bending_eta7.SetLineWidth(1)
    ...
    num_signal_seg_per_chamber_per_event_bending_eta8.SetXTitle("Bending Angle (sbits/layer)")
    num_signal_seg_per_chamber_per_event_bending_eta8.SetYTitle("Nr. of Segments per Stack per BX")
    num_signal_seg_per_chamber_per_event_bending_eta8.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_bending_eta8.Draw("same HE")
    num_signal_seg_per_chamber_per_event_bending_eta8.SetMarkerStyle(8)
    num_signal_seg_per_chamber_per_event_bending_eta8.SetMarkerSize(1)
    num_signal_seg_per_chamber_per_event_bending_eta8.SetMarkerColor(1)
    num_signal_seg_per_chamber_per_event_bending_eta8.SetLineWidth(1)
    ...
    c13e.SetLeftMargin(0.12)
    c13e.SetGrid()
    c13e.DrawFrame(-2, 0, 2, 1.1*num_signal_seg_per_chamber_per_event_bending.GetMaximum(), ";Bending Angle (sbits/layer);Nr. of Signal Segments per Stack per BX")
    ...
    c13f.SetLeftMargin(0.12)
    c13f.SetGrid()
    num_bkg_seg_per_chamber_per_event_nlayers.SetStats(False)
    num_bkg_seg_per_chamber_per_event_nlayers.SetTitle("")
    num_bkg_seg_per_chamber_per_event_nlayers.SetXTitle("Number of Layers Hit")
    num_bkg_seg_per_chamber_per_event_nlayers.SetYTitle("Nr. of Segments per Stack per BX")
    num_bkg_seg_per_chamber_per_event_nlayers.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_nlayers.Draw("same HE")
    num_bkg_seg_per_chamber_per_event_nlayers.SetMarkerStyle(8)
    num_bkg_seg_per_chamber_per_event_nlayers.SetMarkerSize(1)
    num_bkg_seg_per_chamber_per_event_nlayers.SetMarkerColor(1)
    num_bkg_seg_per_chamber_per_event_nlayers.SetLineWidth(1)
    ...
    c13f_eta1.SetLeftMargin(0.12)
    c13f_eta1.SetGrid()
    num_bkg_seg_per_chamber_per_event_nlayers_eta1.SetStats(False)
    num_bkg_seg_per_chamber_per_event_nlayers_eta1.SetTitle("")
    num_bkg_seg_per_chamber_per_event_nlayers_eta1.SetXTitle("Number of Layers Hit")
    num_bkg_seg_per_chamber_per_event_nlayers_eta1.SetYTitle("Nr. of Segments per Stack per BX")
    num_bkg_seg_per_chamber_per_event_nlayers_eta1.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_nlayers_eta1.Draw("same HE")
    num_bkg_seg_per_chamber_per_event_nlayers_eta1.SetMarkerStyle(8)
    num_bkg_seg_per_chamber_per_event_nlayers_eta1.SetMarkerSize(1)
    num_bkg_seg_per_chamber_per_event_nlayers_eta1.SetMarkerColor(1)
    num_bkg_seg_per_chamber_per_event_nlayers_eta1.SetLineWidth(1)
    ...
    c13f_eta2.SetLeftMargin(0.12)
    c13f_eta2.SetGrid()
    num_bkg_seg_per_chamber_per_event_nlayers_eta2.SetStats(False)
    num_bkg_seg_per_chamber_per_event_nlayers_eta2.SetTitle("")
    num_bkg_seg_per_chamber_per_event_nlayers_eta2.SetXTitle("Number of Layers Hit")
    num_bkg_seg_per_chamber_per_event_nlayers_eta2.SetYTitle("Nr. of Segments per Stack per BX")
    num_bkg_seg_per_chamber_per_event_nlayers_eta2.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_nlayers_eta2.Draw("same HE")
    num_bkg_seg_per_chamber_per_event_nlayers_eta2.SetMarkerStyle(8)
    num_bkg_seg_per_chamber_per_event_nlayers_eta2.SetMarkerSize(1)
    num_bkg_seg_per_chamber_per_event_nlayers_eta2.SetMarkerColor(1)
    num_bkg_seg_per_chamber_per_event_nlayers_eta2.SetLineWidth(1)
    ...
    c13f_eta3.SetLeftMargin(0.12)
    c13f_eta3.SetGrid()
    num_bkg_seg_per_chamber_per_event_nlayers_eta3.SetStats(False)
    num_bkg_seg_per_chamber_per_event_nlayers_eta3.SetTitle("")
    num_bkg_seg_per_chamber_per_event_nlayers_eta3.SetXTitle("Number of Layers Hit")
    num_bkg_seg_per_chamber_per_event_nlayers_eta3.SetYTitle("Nr. of Segments per Stack per BX")
    num_bkg_seg_per_chamber_per_event_nlayers_eta3.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_nlayers_eta3.Draw("same HE")
    num_bkg_seg_per_chamber_per_event_nlayers_eta3.SetMarkerStyle(8)
    num_bkg_seg_per_chamber_per_event_nlayers_eta3.SetMarkerSize(1)
    num_bkg_seg_per_chamber_per_event_nlayers_eta3.SetMarkerColor(1)
    num_bkg_seg_per_chamber_per_event_nlayers_eta3.SetLineWidth(1)
    ...
    c13f_eta4.SetLeftMargin(0.12)
    c13f_eta4.SetGrid()
    num_bkg_seg_per_chamber_per_event_nlayers_eta4.SetStats(False)
    num_bkg_seg_per_chamber_per_event_nlayers_eta4.SetTitle("")
    num_bkg_seg_per_chamber_per_event_nlayers_eta4.SetXTitle("Number of Layers Hit")
    num_bkg_seg_per_chamber_per_event_nlayers_eta4.SetYTitle("Nr. of Segments per Stack per BX")
    num_bkg_seg_per_chamber_per_event_nlayers_eta4.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_nlayers_eta4.Draw("same HE")
    num_bkg_seg_per_chamber_per_event_nlayers_eta4.SetMarkerStyle(8)
    num_bkg_seg_per_chamber_per_event_nlayers_eta4.SetMarkerSize(1)
    num_bkg_seg_per_chamber_per_event_nlayers_eta4.SetMarkerColor(1)
    num_bkg_seg_per_chamber_per_event_nlayers_eta4.SetLineWidth(1)
    ...
    c13f_eta5.SetLeftMargin(0.12)
    c13f_eta5.SetGrid()
    num_bkg_seg_per_chamber_per_event_nlayers_eta5.SetStats(False)
    num_bkg_seg_per_chamber_per_event_nlayers_eta5.SetTitle("")
    num_bkg_seg_per_chamber_per_event_nlayers_eta5.SetXTitle("Number of Layers Hit")
    num_bkg_seg_per_chamber_per_event_nlayers_eta5.SetYTitle("Nr. of Segments per Stack per BX")
    num_bkg_seg_per_chamber_per_event_nlayers_eta5.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_nlayers_eta5.Draw("same HE")
    num_bkg_seg_per_chamber_per_event_nlayers_eta5.SetMarkerStyle(8)
    num_bkg_seg_per_chamber_per_event_nlayers_eta5.SetMarkerSize(1)
    num_bkg_seg_per_chamber_per_event_nlayers_eta5.SetMarkerColor(1)
    num_bkg_seg_per_chamber_per_event_nlayers_eta5.SetLineWidth(1)
    ...
    c13f_eta6.SetLeftMargin(0.12)
    c13f_eta6.SetGrid()
    num_bkg_seg_per_chamber_per_event_nlayers_eta6.SetStats(False)
    num_bkg_seg_per_chamber_per_event_nlayers_eta6.SetTitle("")
    num_bkg_seg_per_chamber_per_event_nlayers_eta6.SetXTitle("Number of Layers Hit")
    num_bkg_seg_per_chamber_per_event_nlayers_eta6.SetYTitle("Nr. of Segments per Stack per BX")
    num_bkg_seg_per_chamber_per_event_nlayers_eta6.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_nlayers_eta6.Draw("same HE")
    num_bkg_seg_per_chamber_per_event_nlayers_eta6.SetMarkerStyle(8)
    num_bkg_seg_per_chamber_per_event_nlayers_eta6.SetMarkerSize(1)
    num_bkg_seg_per_chamber_per_event_nlayers_eta6.SetMarkerColor(1)
    num_bkg_seg_per_chamber_per_event_nlayers_eta6.SetLineWidth(1)
    ...
    c13f_eta7.SetLeftMargin(0.12)
    c13f_eta7.SetGrid()
    num_bkg_seg_per_chamber_per_event_nlayers_eta7.SetStats(False)
    num_bkg_seg_per_chamber_per_event_nlayers_eta7.SetTitle("")
    num_bkg_seg_per_chamber_per_event_nlayers_eta7.SetXTitle("Number of Layers Hit")
    num_bkg_seg_per_chamber_per_event_nlayers_eta7.SetYTitle("Nr. of Segments per Stack per BX")
    num_bkg_seg_per_chamber_per_event_nlayers_eta7.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_nlayers_eta7.Draw("same HE")
    num_bkg_seg_per_chamber_per_event_nlayers_eta7.SetMarkerStyle(8)
    num_bkg_seg_per_chamber_per_event_nlayers_eta7.SetMarkerSize(1)
    num_bkg_seg_per_chamber_per_event_nlayers_eta7.SetMarkerColor(1)
    num_bkg_seg_per_chamber_per_event_nlayers_eta7.SetLineWidth(1)
    ...
    c13f_eta8.SetLeftMargin(0.12)
    c13f_eta8.SetGrid()
    num_bkg_seg_per_chamber_per_event_nlayers_eta8.SetStats(False)
    num_bkg_seg_per_chamber_per_event_nlayers_eta8.SetTitle("")
    num_bkg_seg_per_chamber_per_event_nlayers_eta8.SetXTitle("Number of Layers Hit")
    num_bkg_seg_per_chamber_per_event_nlayers_eta8.SetYTitle("Nr. of Segments per Stack per BX")
    num_bkg_seg_per_chamber_per_event_nlayers_eta8.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_nlayers_eta8.Draw("same HE")
    num_bkg_seg_per_chamber_per_event_nlayers_eta8.SetMarkerStyle(8)
    num_bkg_seg_per_chamber_per_event_nlayers_eta8.SetMarkerSize(1)
    num_bkg_seg_per_chamber_per_event_nlayers_eta8.SetMarkerColor(1)
    num_bkg_seg_per_chamber_per_event_nlayers_eta8.SetLineWidth(1)
    ...
    c13g.SetLeftMargin(0.12)
    c13g.SetGrid()
    c13g.DrawFrame(0, 0, 7, 1.1*num_bkg_seg_per_chamber_per_event_nlayers.GetMaximum(), ";Number of Layers Hit;Nr. of Segments per Stack per BX")
    ...
    num_bkg_seg_per_chamber_per_event_nlayers3.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_nlayers4.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_nlayers5.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_nlayers6.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_nlayers7.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_nlayers8.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_nlayers9.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_nlayers10.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_nlayers11.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_nlayers12.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_nlayers13.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_nlayers14.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_nlayers15.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_nlayers16.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_nlayers17.Scale(1/(36.0*n_total_events))
    num_bkg_seg_per_chamber_per_event_nlayers1.SetFillColor(3)
    num_bkg_seg_per_chamber_per_event_nlayers2.SetFillColor(2)
    num_bkg_seg_per_chamber_per_event_nlayers3.SetFillColor(4)
    num_bkg_seg_per_chamber_per_event_nlayers4.SetFillColor(6)
    num_bkg_seg_per_chamber_per_event_nlayers5.SetFillColor(7)
    num_bkg_seg_per_chamber_per_event_nlayers6.SetFillColor(8)
    num_bkg_seg_per_chamber_per_event_nlayers7.SetFillColor(9)
    num_bkg_seg_per_chamber_per_event_nlayers8.SetFillColor(11)
    num_bkg_seg_per_chamber_per_event_nlayers9.SetFillColor(14)
    num_bkg_seg_per_chamber_per_event_nlayers10.SetFillColor(28)
    num_bkg_seg_per_chamber_per_event_nlayers11.SetFillColor(30)
    num_bkg_seg_per_chamber_per_event_nlayers12.SetFillColor(38)
    num_bkg_seg_per_chamber_per_event_nlayers13.SetFillColor(39)
    num_bkg_seg_per_chamber_per_event_nlayers14.SetFillColor(41)
    num_bkg_seg_per_chamber_per_event_nlayers15.SetFillColor(42)
    num_bkg_seg_per_chamber_per_event_nlayers16.SetFillColor(45)
    num_bkg_seg_per_chamber_per_event_nlayers17.SetFillColor(46)
    num_bkg_seg_per_chamber_per_event_nlayers_stack.Add(num_bkg_seg_per_chamber_per_event_nlayers1)
    num_bkg_seg_per_chamber_per_event_nlayers_stack.Add(num_bkg_seg_per_chamber_per_event_nlayers2)
    num_bkg_seg_per_chamber_per_event_nlayers_stack.Add(num_bkg_seg_per_chamber_per_event_nlayers3)
    num_bkg_seg_per_chamber_per_event_nlayers_stack.Add(num_bkg_seg_per_chamber_per_event_nlayers4)
    num_bkg_seg_per_chamber_per_event_nlayers_stack.Add(num_bkg_seg_per_chamber_per_event_nlayers5)
    num_bkg_seg_per_chamber_per_event_nlayers_stack.Add(num_bkg_seg_per_chamber_per_event_nlayers6)
    num_bkg_seg_per_chamber_per_event_nlayers_stack.Add(num_bkg_seg_per_chamber_per_event_nlayers7)
    num_bkg_seg_per_chamber_per_event_nlayers_stack.Add(num_bkg_seg_per_chamber_per_event_nlayers8)
    num_bkg_seg_per_chamber_per_event_nlayers_stack.Add(num_bkg_seg_per_chamber_per_event_nlayers9)
    num_bkg_seg_per_chamber_per_event_nlayers_stack.Add(num_bkg_seg_per_chamber_per_event_nlayers10)
    num_bkg_seg_per_chamber_per_event_nlayers_stack.Add(num_bkg_seg_per_chamber_per_event_nlayers11)
    num_bkg_seg_per_chamber_per_event_nlayers_stack.Add(num_bkg_seg_per_chamber_per_event_nlayers12)
    num_bkg_seg_per_chamber_per_event_nlayers_stack.Add(num_bkg_seg_per_chamber_per_event_nlayers13)
    num_bkg_seg_per_chamber_per_event_nlayers_stack.Add(num_bkg_seg_per_chamber_per_event_nlayers14)
    num_bkg_seg_per_chamber_per_event_nlayers_stack.Add(num_bkg_seg_per_chamber_per_event_nlayers15)
    num_bkg_seg_per_chamber_per_event_nlayers_stack.Add(num_bkg_seg_per_chamber_per_event_nlayers16)
    num_bkg_seg_per_chamber_per_event_nlayers_stack.Add(num_bkg_seg_per_chamber_per_event_nlayers17)
    num_bkg_seg_per_chamber_per_event_nlayers_stack.Draw("same HE")
    ROOT.gPad.Update()
    leg13g = ROOT.TLegend(0.15,0.1,0.25,0.6)
    leg13g.AddEntry(num_bkg_seg_per_chamber_per_event_nlayers1,"ID 1", "f")
    leg13g.AddEntry(num_bkg_seg_per_chamber_per_event_nlayers2,"ID 2", "f")
    leg13g.AddEntry(num_bkg_seg_per_chamber_per_event_nlayers3,"ID 3", "f")
    leg13g.AddEntry(num_bkg_seg_per_chamber_per_event_nlayers4,"ID 4", "f")
    leg13g.AddEntry(num_bkg_seg_per_chamber_per_event_nlayers5,"ID 5", "f")
    leg13g.AddEntry(num_bkg_seg_per_chamber_per_event_nlayers6,"ID 6", "f")
    leg13g.AddEntry(num_bkg_seg_per_chamber_per_event_nlayers7,"ID 7", "f")
    leg13g.AddEntry(num_bkg_seg_per_chamber_per_event_nlayers8,"ID 8", "f")
    leg13g.AddEntry(num_bkg_seg_per_chamber_per_event_nlayers9,"ID 9", "f")
    leg13g.AddEntry(num_bkg_seg_per_chamber_per_event_nlayers10,"ID 10", "f")
    leg13g.AddEntry(num_bkg_seg_per_chamber_per_event_nlayers11,"ID 11", "f")
    leg13g.AddEntry(num_bkg_seg_per_chamber_per_event_nlayers12,"ID 12", "f")
    leg13g.AddEntry(num_bkg_seg_per_chamber_per_event_nlayers13,"ID 13", "f")
    leg13g.AddEntry(num_bkg_seg_per_chamber_per_event_nlayers14,"ID 14", "f")
    leg13g.AddEntry(num_bkg_seg_per_chamber_per_event_nlayers15,"ID 15", "f")
    leg13g.AddEntry(num_bkg_seg_per_chamber_per_event_nlayers16,"ID 16", "f")
    ...
    num_bkg_seg_per_chamber_per_event_nlayers3.Write()
    num_bkg_seg_per_chamber_per_event_nlayers4.Write()
    num_bkg_seg_per_chamber_per_event_nlayers5.Write()
    num_bkg_seg_per_chamber_per_event_nlayers6.Write()
    num_bkg_seg_per_chamber_per_event_nlayers7.Write()
    num_bkg_seg_per_chamber_per_event_nlayers8.Write()
    num_bkg_seg_per_chamber_per_event_nlayers9.Write()
    num_bkg_seg_per_chamber_per_event_nlayers10.Write()
    num_bkg_seg_per_chamber_per_event_nlayers11.Write()
    num_bkg_seg_per_chamber_per_event_nlayers12.Write()
    num_bkg_seg_per_chamber_per_event_nlayers13.Write()
    num_bkg_seg_per_chamber_per_event_nlayers14.Write()
    num_bkg_seg_per_chamber_per_event_nlayers15.Write()
    num_bkg_seg_per_chamber_per_event_nlayers16.Write()
    num_bkg_seg_per_chamber_per_event_nlayers17.Write()

    c13h = ROOT.TCanvas('', '', 800, 650)
    c13h.SetLeftMargin(0.12)
    c13h.SetGrid()
    num_signal_seg_per_chamber_per_event_nlayers.SetStats(False)
    num_signal_seg_per_chamber_per_event_nlayers.SetTitle("")
    num_signal_seg_per_chamber_per_event_nlayers.SetXTitle("Number of Layers Hit")
    num_signal_seg_per_chamber_per_event_nlayers.SetYTitle("Nr. of Signal Segments per Stack per BX")
    num_signal_seg_per_chamber_per_event_nlayers.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_nlayers.Draw("same HE")
    num_signal_seg_per_chamber_per_event_nlayers.SetMarkerStyle(8)
    num_signal_seg_per_chamber_per_event_nlayers.SetMarkerSize(1)
    num_signal_seg_per_chamber_per_event_nlayers.SetMarkerColor(1)
    num_signal_seg_per_chamber_per_event_nlayers.SetLineWidth(1)
    ...
    num_signal_seg_per_chamber_per_event_nlayers_eta1.SetXTitle("Number of Layers Hit")
    num_signal_seg_per_chamber_per_event_nlayers_eta1.SetYTitle("Nr. of Segments per Stack per BX")
    num_signal_seg_per_chamber_per_event_nlayers_eta1.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_nlayers_eta1.Draw("same HE")
    num_signal_seg_per_chamber_per_event_nlayers_eta1.SetMarkerStyle(8)
    num_signal_seg_per_chamber_per_event_nlayers_eta1.SetMarkerSize(1)
    num_signal_seg_per_chamber_per_event_nlayers_eta1.SetMarkerColor(1)
    num_signal_seg_per_chamber_per_event_nlayers_eta1.SetLineWidth(1)
    ...
    num_signal_seg_per_chamber_per_event_nlayers_eta2.SetXTitle("Number of Layers Hit")
    num_signal_seg_per_chamber_per_event_nlayers_eta2.SetYTitle("Nr. of Segments per Stack per BX")
    num_signal_seg_per_chamber_per_event_nlayers_eta2.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_nlayers_eta2.Draw("same HE")
    num_signal_seg_per_chamber_per_event_nlayers_eta2.SetMarkerStyle(8)
    num_signal_seg_per_chamber_per_event_nlayers_eta2.SetMarkerSize(1)
    num_signal_seg_per_chamber_per_event_nlayers_eta2.SetMarkerColor(1)
    num_signal_seg_per_chamber_per_event_nlayers_eta2.SetLineWidth(1)
    ...
    num_signal_seg_per_chamber_per_event_nlayers_eta3.SetXTitle("Number of Layers Hit")
    num_signal_seg_per_chamber_per_event_nlayers_eta3.SetYTitle("Nr. of Segments per Stack per BX")
    num_signal_seg_per_chamber_per_event_nlayers_eta3.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_nlayers_eta3.Draw("same HE")
    num_signal_seg_per_chamber_per_event_nlayers_eta3.SetMarkerStyle(8)
    num_signal_seg_per_chamber_per_event_nlayers_eta3.SetMarkerSize(1)
    num_signal_seg_per_chamber_per_event_nlayers_eta3.SetMarkerColor(1)
    num_signal_seg_per_chamber_per_event_nlayers_eta3.SetLineWidth(1)
    ...
    num_signal_seg_per_chamber_per_event_nlayers_eta4.SetXTitle("Number of Layers Hit")
    num_signal_seg_per_chamber_per_event_nlayers_eta4.SetYTitle("Nr. of Segments per Stack per BX")
    num_signal_seg_per_chamber_per_event_nlayers_eta4.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_nlayers_eta4.Draw("same HE")
    num_signal_seg_per_chamber_per_event_nlayers_eta4.SetMarkerStyle(8)
    num_signal_seg_per_chamber_per_event_nlayers_eta4.SetMarkerSize(1)
    num_signal_seg_per_chamber_per_event_nlayers_eta4.SetMarkerColor(1)
    num_signal_seg_per_chamber_per_event_nlayers_eta4.SetLineWidth(1)
    ...
    c13h_eta5 = ROOT.TCanvas('', '', 800, 650)
    c13h_eta5.SetGrid()
    num_signal_seg_per_chamber_per_event_nlayers_eta5.SetStats(False)
    num_signal_seg_per_chamber_per_event_nlayers_eta5.SetTitle("")
    num_signal_seg_per_chamber_per_event_nlayers_eta5.SetXTitle("Number of Layers Hit")
    num_signal_seg_per_chamber_per_event_nlayers_eta5.SetYTitle("Nr. of Segments per Stack per BX")
    num_signal_seg_per_chamber_per_event_nlayers_eta5.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_nlayers_eta5.Draw("same HE")
    num_signal_seg_per_chamber_per_event_nlayers_eta5.SetMarkerStyle(8)
    num_signal_seg_per_chamber_per_event_nlayers_eta5.SetMarkerSize(1)
    num_signal_seg_per_chamber_per_event_nlayers_eta5.SetMarkerColor(1)
    num_signal_seg_per_chamber_per_event_nlayers_eta5.SetLineWidth(1)
    ...
    num_signal_seg_per_chamber_per_event_nlayers_eta6.SetXTitle("Number of Layers Hit")
    num_signal_seg_per_chamber_per_event_nlayers_eta6.SetYTitle("Nr. of Segments per Stack per BX")
    num_signal_seg_per_chamber_per_event_nlayers_eta6.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_nlayers_eta6.Draw("same HE")
    num_signal_seg_per_chamber_per_event_nlayers_eta6.SetMarkerStyle(8)
    num_signal_seg_per_chamber_per_event_nlayers_eta6.SetMarkerSize(1)
    num_signal_seg_per_chamber_per_event_nlayers_eta6.SetMarkerColor(1)
    num_signal_seg_per_chamber_per_event_nlayers_eta6.SetLineWidth(1)
    ...
    num_signal_seg_per_chamber_per_event_nlayers_eta7.SetXTitle("Number of Layers Hit")
    num_signal_seg_per_chamber_per_event_nlayers_eta7.SetYTitle("Nr. of Segments per Stack per BX")
    num_signal_seg_per_chamber_per_event_nlayers_eta7.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_nlayers_eta7.Draw("same HE")
    num_signal_seg_per_chamber_per_event_nlayers_eta7.SetMarkerStyle(8)
    num_signal_seg_per_chamber_per_event_nlayers_eta7.SetMarkerSize(1)
    num_signal_seg_per_chamber_per_event_nlayers_eta7.SetMarkerColor(1)
    num_signal_seg_per_chamber_per_event_nlayers_eta7.SetLineWidth(1)
    ...
    num_signal_seg_per_chamber_per_event_nlayers_eta8.SetXTitle("Number of Layers Hit")
    num_signal_seg_per_chamber_per_event_nlayers_eta8.SetYTitle("Nr. of Segments per Stack per BX")
    num_signal_seg_per_chamber_per_event_nlayers_eta8.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_nlayers_eta8.Draw("same HE")
    num_signal_seg_per_chamber_per_event_nlayers_eta8.SetMarkerStyle(8)
    num_signal_seg_per_chamber_per_event_nlayers_eta8.SetMarkerSize(1)
    num_signal_seg_per_chamber_per_event_nlayers_eta8.SetMarkerColor(1)
    num_signal_seg_per_chamber_per_event_nlayers_eta8.SetLineWidth(1)
    ...
    c13i.SetLeftMargin(0.12)
    c13i.SetGrid()
    c13i.DrawFrame(0, 0, 7, 1.1*num_signal_seg_per_chamber_per_event_nlayers.GetMaximum(), ";Number of Layers Hit;Nr. of Signal Segments per Stack per BX")
    ...
    num_signal_seg_per_chamber_per_event_nlayers3.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_nlayers4.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_nlayers5.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_nlayers6.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_nlayers7.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_nlayers8.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_nlayers9.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_nlayers10.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_nlayers11.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_nlayers12.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_nlayers13.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_nlayers14.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_nlayers15.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_nlayers16.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_nlayers17.Scale(1/(36.0*n_total_events))
    num_signal_seg_per_chamber_per_event_nlayers1.SetFillColor(3)
    num_signal_seg_per_chamber_per_event_nlayers2.SetFillColor(2)
    num_signal_seg_per_chamber_per_event_nlayers3.SetFillColor(4)
    num_signal_seg_per_chamber_per_event_nlayers4.SetFillColor(6)
    num_signal_seg_per_chamber_per_event_nlayers5.SetFillColor(7)
    num_signal_seg_per_chamber_per_event_nlayers6.SetFillColor(8)
    num_signal_seg_per_chamber_per_event_nlayers7.SetFillColor(9)
    num_signal_seg_per_chamber_per_event_nlayers8.SetFillColor(11)
    num_signal_seg_per_chamber_per_event_nlayers9.SetFillColor(14)
    num_signal_seg_per_chamber_per_event_nlayers10.SetFillColor(28)
    num_signal_seg_per_chamber_per_event_nlayers11.SetFillColor(30)
    num_signal_seg_per_chamber_per_event_nlayers12.SetFillColor(38)
    num_signal_seg_per_chamber_per_event_nlayers13.SetFillColor(39)
    num_signal_seg_per_chamber_per_event_nlayers14.SetFillColor(41)
    num_signal_seg_per_chamber_per_event_nlayers15.SetFillColor(42)
    num_signal_seg_per_chamber_per_event_nlayers16.SetFillColor(45)
    num_signal_seg_per_chamber_per_event_nlayers17.SetFillColor(46)
    num_signal_seg_per_chamber_per_event_nlayers_stack.Add(num_signal_seg_per_chamber_per_event_nlayers1)
    num_signal_seg_per_chamber_per_event_nlayers_stack.Add(num_signal_seg_per_chamber_per_event_nlayers2)
    num_signal_seg_per_chamber_per_event_nlayers_stack.Add(num_signal_seg_per_chamber_per_event_nlayers3)
    num_signal_seg_per_chamber_per_event_nlayers_stack.Add(num_signal_seg_per_chamber_per_event_nlayers4)
    num_signal_seg_per_chamber_per_event_nlayers_stack.Add(num_signal_seg_per_chamber_per_event_nlayers5)
    num_signal_seg_per_chamber_per_event_nlayers_stack.Add(num_signal_seg_per_chamber_per_event_nlayers6)
    num_signal_seg_per_chamber_per_event_nlayers_stack.Add(num_signal_seg_per_chamber_per_event_nlayers7)
    num_signal_seg_per_chamber_per_event_nlayers_stack.Add(num_signal_seg_per_chamber_per_event_nlayers8)
    num_signal_seg_per_chamber_per_event_nlayers_stack.Add(num_signal_seg_per_chamber_per_event_nlayers9)
    num_signal_seg_per_chamber_per_event_nlayers_stack.Add(num_signal_seg_per_chamber_per_event_nlayers10)
    num_signal_seg_per_chamber_per_event_nlayers_stack.Add(num_signal_seg_per_chamber_per_event_nlayers11)
    num_signal_seg_per_chamber_per_event_nlayers_stack.Add(num_signal_seg_per_chamber_per_event_nlayers12)
    num_signal_seg_per_chamber_per_event_nlayers_stack.Add(num_signal_seg_per_chamber_per_event_nlayers13)
    num_signal_seg_per_chamber_per_event_nlayers_stack.Add(num_signal_seg_per_chamber_per_event_nlayers14)
    num_signal_seg_per_chamber_per_event_nlayers_stack.Add(num_signal_seg_per_chamber_per_event_nlayers15)
    num_signal_seg_per_chamber_per_event_nlayers_stack.Add(num_signal_seg_per_chamber_per_event_nlayers16)
    num_signal_seg_per_chamber_per_event_nlayers_stack.Add(num_signal_seg_per_chamber_per_event_nlayers17)
    num_signal_seg_per_chamber_per_event_nlayers_stack.Draw("same HE")
    ROOT.gPad.Update()
    leg13i = ROOT.TLegend(0.15,0.1,0.25,0.6)
    leg13i.AddEntry(num_signal_seg_per_chamber_per_event_nlayers1,"ID 1", "f")
    leg13i.AddEntry(num_signal_seg_per_chamber_per_event_nlayers2,"ID 2", "f")
    leg13i.AddEntry(num_signal_seg_per_chamber_per_event_nlayers3,"ID 3", "f")
    leg13i.AddEntry(num_signal_seg_per_chamber_per_event_nlayers4,"ID 4", "f")
    leg13i.AddEntry(num_signal_seg_per_chamber_per_event_nlayers5,"ID 5", "f")
    leg13i.AddEntry(num_signal_seg_per_chamber_per_event_nlayers6,"ID 6", "f")
    leg13i.AddEntry(num_signal_seg_per_chamber_per_event_nlayers7,"ID 7", "f")
    leg13i.AddEntry(num_signal_seg_per_chamber_per_event_nlayers8,"ID 8", "f")
    leg13i.AddEntry(num_signal_seg_per_chamber_per_event_nlayers9,"ID 9", "f")
    leg13i.AddEntry(num_signal_seg_per_chamber_per_event_nlayers10,"ID 10", "f")
    leg13i.AddEntry(num_signal_seg_per_chamber_per_event_nlayers11,"ID 11", "f")
    leg13i.AddEntry(num_signal_seg_per_chamber_per_event_nlayers12,"ID 12", "f")
    leg13i.AddEntry(num_signal_seg_per_chamber_per_event_nlayers13,"ID 13", "f")
    leg13i.AddEntry(num_signal_seg_per_chamber_per_event_nlayers14,"ID 14", "f")
    leg13i.AddEntry(num_signal_seg_per_chamber_per_event_nlayers15,"ID 15", "f")
    leg13i.AddEntry(num_signal_seg_per_chamber_per_event_nlayers16,"ID 16", "f")
    ...
    num_signal_seg_per_chamber_per_event_nlayers3.Write()
    num_signal_seg_per_chamber_per_event_nlayers4.Write()
    num_signal_seg_per_chamber_per_event_nlayers5.Write()
    num_signal_seg_per_chamber_per_event_nlayers6.Write()
    num_signal_seg_per_chamber_per_event_nlayers7.Write()
    num_signal_seg_per_chamber_per_event_nlayers8.Write()
    num_signal_seg_per_chamber_per_event_nlayers9.Write()
    num_signal_seg_per_chamber_per_event_nlayers10.Write()
    num_signal_seg_per_chamber_per_event_nlayers11.Write()
    num_signal_seg_per_chamber_per_event_nlayers12.Write()
    num_signal_seg_per_chamber_per_event_nlayers13.Write()
    num_signal_seg_per_chamber_per_event_nlayers14.Write()
    ...
    c_max_noise_p.SetLeftMargin(0.12)
    ...
    c_nlayers_withcsg3_p.SetLeftMargin(0.12)
    ...
    c_nlayers_withcsg5_p.SetLeftMargin(0.12)
    ...
    c_nlayers_withcsg10_p.SetLeftMargin(0.12)
    ...
    c_nlayers_withcsg15_p.SetLeftMargin(0.12)
    ...
    c_nlayers_withnoiseg3_p.SetLeftMargin(0.12)
    ...
    c_nlayers_withnoiseg5_p.SetLeftMargin(0.12)
    ...
    c_nlayers_withnoiseg10_p.SetLeftMargin(0.12)
    ...
    c_nlayers_withnoiseg15_p.SetLeftMargin(0.12)
    ...
    c_max_cluster_size_e.SetLeftMargin(0.12)
    ...
    c_max_noise_e.SetLeftMargin(0.12)
    ...
    c_nlayers_withcsg3_e.SetLeftMargin(0.12)
    ...
    c_nlayers_withcsg5_e.SetLeftMargin(0.12)
    ...
    c_nlayers_withcsg10_e.SetLeftMargin(0.12)
    ...
    c_nlayers_withcsg15_e.SetLeftMargin(0.12)
    ...
    c_nlayers_withnoiseg3_e.SetLeftMargin(0.12)
    ...
    c_nlayers_withnoiseg5_e.SetLeftMargin(0.12)
    ...
    c_nlayers_withnoiseg10_e.SetLeftMargin(0.12)
    ...
    c_nlayers_withnoiseg15_e.SetLeftMargin(0.12)
