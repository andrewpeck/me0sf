...
def analysis(root_dat, hits, bx, bx_list, cross_part, verbose, pu, num_or):
    ...
    num_signal_seg_per_chamber_per_event_bending_eta1 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_bending_eta1", "num_signal_seg_per_chamber_per_event_bending_eta1",80,-4,4)
    num_signal_seg_per_chamber_per_event_bending_eta2 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_bending_eta2", "num_signal_seg_per_chamber_per_event_bending_eta2",80,-4,4)
    num_signal_seg_per_chamber_per_event_bending_eta3 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_bending_eta3", "num_signal_seg_per_chamber_per_event_bending_eta3",80,-4,4)
    num_signal_seg_per_chamber_per_event_bending_eta4 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_bending_eta4", "num_signal_seg_per_chamber_per_event_bending_eta4",80,-4,4)
    num_signal_seg_per_chamber_per_event_bending_eta5 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_bending_eta5", "num_signal_seg_per_chamber_per_event_bending_eta5",80,-4,4)
    num_signal_seg_per_chamber_per_event_bending_eta6 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_bending_eta6", "num_signal_seg_per_chamber_per_event_bending_eta6",80,-4,4)
    num_signal_seg_per_chamber_per_event_bending_eta7 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_bending_eta7", "num_signal_seg_per_chamber_per_event_bending_eta7",80,-4,4)
    num_signal_seg_per_chamber_per_event_bending_eta8 = ROOT.TH1F("num_signal_seg_per_chamber_per_event_bending_eta8", "num_signal_seg_per_chamber_per_event_bending_eta8",80,-4,4)
    ...
    ROOT.gPad.Update()
    leg13g = ROOT.TLegend(0.8,0.1,0.9,0.6)
    ...
    ROOT.gPad.Update()
    leg13i = ROOT.TLegend(0.8,0.1,0.9,0.6)
