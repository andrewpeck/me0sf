...
if __name__ == "__main__":
    ...
    c1.DrawFrame(-8, 0, 8, 1.1, "Efficiency w.r.t. Offline Segments; Bending Angle (sbits/layer); #epsilon")
    ...
    offline_effi_mres.GetXaxis().SetTitle("Bending Angle (sbits/layer)")
    ...
    st_effi_mres.GetXaxis().SetTitle("Bending Angle (sbits/layer)")
    ...
    st_effi_sres.GetXaxis().SetTitle("Sbit")
